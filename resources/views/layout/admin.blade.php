        ...
        <div class="sidebar-menu-area">
            <ul class="sidebar-menu" id="sidebar-menu">
                ...
                <li class="dropdown">
                    ...
                    {{-- <ul class="sidebar-submenu">
                        <li><a href="{{ route('report.list') }}"><i
                                    class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> List</a></li>
                        <li><a href="{{ route('report.preview') }}"><i
                                    class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Preview</a></li>
                        <li><a href="{{ route('report.add') }}"><i
                                    class="ri-circle-fill circle-icon text-info-main w-auto"></i> Add New</a></li>
                        <li><a href="{{ route('report.edit') }}"><i
                                    class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Edit</a></li>
                    </ul> --}}
                </li>
