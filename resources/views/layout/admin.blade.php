...
<html lang="en" data-theme="light">
    ...
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/apexcharts.css') }}"
        />

        <!-- Data Table -->
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/dataTables.min.css') }}"
        />

        <!-- Text Editor -->
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/editor-katex.min.css') }}"
        />
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/editor.atom-one-dark.min.css') }}"
        />
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/editor.quill.snow.css') }}"
        />

        <!-- Date Picker -->
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/flatpickr.min.css') }}"
        />

        <!-- Calendar -->
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/full-calendar.css') }}"
        />

        <!-- Vector Map -->
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/jquery-jvectormap-2.0.5.css') }}"
        />

        <!-- Popup -->
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/magnific-popup.css') }}"
        />
        ...
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/file-upload.css') }}"
        />

        <!-- Audio Player -->
        <link
            rel="stylesheet"
            href="{{ asset('assets/css/lib/audioplayer.css') }}"
        />
    ...
    <body>
        ...
        <div
            ...
            class="alert alert-{{
                session('type')
            }} alert-dismissible fade show text-center rounded animate-alert top-alert "
            role="alert"
        >
            {{ session("message") }}
            <button
                ...
                <ul class="sidebar-menu" id="sidebar-menu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)">
                            <i
                                class="ri-robot-2-line text-xl me-6 d-flex w-auto"
                            ></i>
                            <span>Course</span>
                        </a>
                    ...
                    <li class="dropdown">
                        ...
                        <a href="javascript:void(0)">
                            <i
                                class="ri-news-line text-xl me-6 d-flex w-auto"
                            ></i>
                            <span>Blog</span>
                        </a>
                        --}} {{--
                    ...
                    <li>
                        ...
                        <a href="{{ route('testimonial.index') }}">
                            <i
                                class="ri-star-line text-xl me-6 d-flex w-auto"
                            ></i>
        ...
        <!-- Bootstrap js -->
        <script src="{{
                asset('assets/js/lib/bootstrap.bundle.min.js')
            }}"></script>
        <!-- Apex Chart js -->
        ...
        <!-- Vector Map js -->
        <script src="{{
                asset('assets/js/lib/jquery-jvectormap-2.0.5.min.js')
            }}"></script>
        <script src="{{
                asset('assets/js/lib/jquery-jvectormap-world-mill-en.js')
            }}"></script>
        <!-- Popup js -->
        <script src="{{
                asset('assets/js/lib/magnifc-popup.min.js')
            }}"></script>
        <!-- Slick Slider js -->
        ...
        <!-- PAGE-SPECIFIC SCRIPTS (DELETE, ALERTS, ETC) -->
        @yield('scripts')
    </body>
