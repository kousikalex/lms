@extends('layout.admin') @section('title', 'Dashboard') @section('content')
<style>
    /* Small title */
    .swal-small-title {
                ...
                <div class="d-flex flex-wrap align-items-center gap-3">
                    ...
                    <div class="dropdown d-none d-sm-inline-block">
                        ...
                        <div class="dropdown-menu to-top dropdown-menu-sm">
                            ...
                            <div
                                class="max-h-400-px overflow-y-auto scroll-sm pe-8"
                            >
                                <div
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            />
                                            <span
                                                class="text-md fw-semibold mb-0"
                                                >English</span
                                            >
                                        </span>
                                    </label>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h6
                                                class="text-md fw-semibold mb-4"
                                            >
                                                Kathryn Murphy
                                            </h6>
                                            <p
                                    ...
                                    >
                                        <span
                                            class="text-sm text-secondary-light flex-shrink-0"
                                            >12:30 PM</span
                                        >
                                        <span
                            ...
                            <table class="table border-primary-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $item->course->name ?? 'No Course Found' }}
                                        </td>
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            @if ($item->image)
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('subcourse.edit', $item->id) }}"
                                            ...
                                            <form
                                                ...
                                                action="{{ route('subcourse.destroy', $item->id) }}"
                                                method="POST"
