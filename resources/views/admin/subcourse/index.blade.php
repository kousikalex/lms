                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('subcourse.create') }}" class="btn btn-primary-600 radius-8 px-20 py-11">
                                Create Course
                            </a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                               ...
                                               <td>{{ $item->course->name ?? 'No Course Found' }}</td>
                                                <td>{{ $item->name }}</td>
                                                 <td>
                                                    @if ($item->image)
                                                ...
                                                <td>
                                                    <a href="{{ route('subcourse.edit', $item->id) }}"
                                                        class="btn btn-sm btn-info">Edit</a>

                                                    <form action="{{ route('subcourse.destroy', $item->id) }}"
