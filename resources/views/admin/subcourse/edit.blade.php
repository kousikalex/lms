    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="row gy-4">
                ...
                <form class="row gy-3 needs-validation" action="{{ route('subcourse.update', $subcourse->id) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            placeholder="Enter Sub Course Name" value="{{ old('name', $subcourse->name) }}">
                        @error('name')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        @if ($subcourse->image)
                            <div class="mt-2">
                                ...
                                <img src="{{ asset('storage/' . $subcourse->image) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror"
                            placeholder="Enter description">{{ old('description', $subcourse->description) }}</textarea>
                        @error('description')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
