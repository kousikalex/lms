    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="row gy-4">
                ...
                <form class="row gy-3 needs-validation" action="{{ route('college.update', $college->id) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="collegename"
                            class="form-control @error('collegename') is-invalid @enderror"
                            value="{{ old('collegename', $college->collegename) }}">
                        @error('collegename')
                    ...
                    <div class="col-md-6">
                        ...
                        @if ($college->Logo)
                            <img src="{{ asset('storage/' . $college->Logo) }}" class="mt-2" width="100"
                                height="100" style="border-radius:6px;">
                        @endif
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="landmark"
                            ...
                            value="{{ old('landmark', $college->landmark) }}">
                        @error('landmark')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror">{{ old('description', $college->description) }}</textarea>
                        @error('description')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-primary-600" type="submit">Update College</button>
                    </div>
                </form>
