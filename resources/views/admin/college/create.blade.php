    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="row gy-4">
                ...
                <form class="row gy-3 needs-validation" action="{{ route('college.store') }}" method="POST"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="collegename"
                            ...
                            placeholder="Enter College Name" value="{{ old('collegename') }}">
                        @error('collegename')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="landmark"
                            class="form-control @error('landmark') is-invalid @enderror" placeholder="Enter Landmark"
                            value="{{ old('landmark') }}">
                        @error('landmark')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="district"
                            class="form-control @error('district') is-invalid @enderror" placeholder="Enter District"
                            value="{{ old('district') }}">
                        @error('district')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror"
                            placeholder="Enter College Description">{{ old('description') }}</textarea>
                        @error('description')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
