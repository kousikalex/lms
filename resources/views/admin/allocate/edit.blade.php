    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="row gy-4">
                ...
                <form class="row gy-3 needs-validation" action="{{ route('allocate.update', $allocate->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <select name="college_id" class="form-control @error('college_id') is-invalid @enderror">
                            ...
                            @foreach ($college as $collegeItem)
                                <option value="{{ $collegeItem->id }}"
                                    {{ old('college_id', $allocate->college_id) == $collegeItem->id ? 'selected' : '' }}>
                        ...
                        <select name="course_id" class="form-control @error('course_id') is-invalid @enderror">
                            ...
                            @foreach ($courses as $course)
                                <option value="{{ $course->id }}"
                                    {{ old('course_id', $allocate->course_id) == $course->id ? 'selected' : '' }}>
                                    {{ $course->name }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="department_id" class="form-control @error('department_id') is-invalid @enderror">
                            ...
                            @foreach ($department as $depart)
                                <option value="{{ $depart->id }}"
                                    {{ old('department_id', $allocate->department_id) == $depart->id ? 'selected' : '' }}>
                                    {{ $depart->name }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="year_id" class="form-control @error('year_id') is-invalid @enderror">
                            ...
                            @foreach ($year as $years)
                                <option value="{{ $years->id }}"
                                    {{ old('year_id', $allocate->year_id) == $years->id ? 'selected' : '' }}>
                                    {{ $years->name }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="section_id" class="form-control @error('section_id') is-invalid @enderror">
                            ...
                            @foreach ($section as $sections)
                                <option value="{{ $sections->id }}"
                                    {{ old('section_id', $allocate->section_id) == $sections->id ? 'selected' : '' }}>
                                    {{ $sections->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="trainer_id" class="form-control @error('trainer_id') is-invalid @enderror">
                            ...
                            @foreach ($trainer as $trainerItem)
                                <option value="{{ $trainerItem->id }}"
                                    {{ old('trainer_id', $allocate->trainer_id) == $trainerItem->id ? 'selected' : '' }}>
                                    {{ $trainerItem->first_name }}
                                </option>
                            @endforeach
                        </select>
                        @error('trainer_id')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="from_date" value="{{ old('from_date', $allocate->from_date) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="to_date" value="{{ old('to_date', $allocate->to_date) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror">{{ old('description', $allocate->description) }}</textarea>
                        @error('description')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
