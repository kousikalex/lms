                            ...
                            <table class="table border-primary-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $item->trainer->first_name ?? 'N/A' }}
                                            -
                                            {{ $item->trainer->trainer_type ?? 'N/A' }}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('allocate.edit', $item->id) }}"
                                            ...
                                            <form
                                                ...
                                                action="{{ route('allocate.destroy', $item->id) }}"
                                                method="POST"
