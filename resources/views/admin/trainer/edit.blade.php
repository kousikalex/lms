    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="row gy-4">
                ...
                <form class="row gy-3 needs-validation" action="{{ route('trainer.update', $trainer->id) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="emergency_name"
                            ...
                            value="{{ old('emergency_name', $trainer->emergency_name) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="emergency_number"
                            ...
                            value="{{ old('emergency_number', $trainer->emergency_number) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="account_number"
                            ...
                            value="{{ old('account_number', $trainer->account_number) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check">
                            <input type="radio" name="trainer_type" value="inhouse"
                                class="form-check-input @error('trainer_type') is-invalid @enderror"
                                {{ old('trainer_type', $trainer->trainer_type) == 'inhouse' ? 'checked' : '' }}>
                            <label>In-house</label>
                        </div>

                        <div class="form-check">
                            <input type="radio" name="trainer_type" value="freelancer"
                                class="form-check-input @error('trainer_type') is-invalid @enderror"
                                {{ old('trainer_type', $trainer->trainer_type) == 'freelancer' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        @if ($trainer->file_upload)
                            <div class="mt-3">

                                @php
                                    $extension = strtolower(pathinfo($trainer->file_upload, PATHINFO_EXTENSION));
                                @endphp

                                {{-- If File is Image --}}
                                @if (in_array($extension, ['jpg', 'jpeg', 'png']))
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $trainer->file_upload) }}" alt="Uploaded file"
                                            width="120" height="120" style="object-fit: cover; border-radius: 6px;">
                                    </div>
                                @endif

                                {{-- Show View File Link --}}
                                <a href="{{ asset('storage/' . $trainer->file_upload) }}" target="_blank"
