    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="row gy-4">
                ...
                <form class="row gy-3 needs-validation" action="{{ route('trainers.store') }}" method="POST"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="emergency_name"
                            ...
                            placeholder="Enter Emergency Name" value="{{ old('emergency_name') }}">
                    ...
                    <div class="col-md-6">
                        <label class="form-label d-block">Trainer Type</label>

                        <div class="form-check">
                            <input class="form-check-input @error('trainer_type') is-invalid @enderror" type="radio"
                                name="trainer_type" value="inhouse"
                                {{ old('trainer_type') == 'inhouse' ? 'checked' : '' }}>
                            <label class="form-check-label">In-house</label>
                        </div>

                        <div class="form-check">
                            <input class="form-check-input @error('trainer_type') is-invalid @enderror" type="radio"
                                name="trainer_type" value="freelancer"
                                {{ old('trainer_type') == 'freelancer' ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="experience"
                            class="form-control @error('experience') is-invalid @enderror" placeholder="Write Experience"
