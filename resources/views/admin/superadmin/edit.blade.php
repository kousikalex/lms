...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-9">
            ...
            <!-- Transparent Card -->
            <div class="card wowdash-card bg-transparent border-0 shadow-none">
                <div class="card-body p-0">

                    <form method="POST" action="{{ route('superadmin.update', $admin->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <!-- Button -->
                        <button class="btn btn-primary-600 mt-3">
                            Update Admin
                        </button>
