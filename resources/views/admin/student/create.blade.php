        ...
        <div class="dashboard-main-body">
            ...
            <div class="row gy-4">
                ...
                <form class="row gy-3 needs-validation" action="{{ route('student.store') }}" method="POST"
                        ...
                        <select name="department_id" class="form-control @error('department_id') is-invalid @enderror">
                            ...
                            @foreach ($department as $departments)
                                <option value="{{ $departments->id }}"
                                    {{ old('department_id') == $departments->id ? 'selected' : '' }}>
                                    {{ $departments->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Upload Students Excel</label>
                        <input type="file" name="students_file"
                            class="form-control @error('students_file') is-invalid @enderror" accept=".xlsx,.xls,.csv">
                        ...
                        <small class="text-muted">
                            Excel columns must be: <b>name, email, contact_number, department, year</b> (as header row).
                        </small>
                    </div>
                    <div class="col-md-6">
