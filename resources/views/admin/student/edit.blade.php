    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="row gy-4">
                ...
                <form class="row gy-3 needs-validation" action="{{ route('student.update', $student->id) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="year_id" class="form-control @error('year_id') is-invalid @enderror">
                            ...
                            @foreach ($years as $y)
                                <option value="{{ $y->id }}"
                                    {{ old('year_id', $student->year_id) == $y->id ? 'selected' : '' }}>
                                    {{ $y->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    {{-- Submit --}}
                    <div class="col-md-12">
                        <button class="btn btn-primary-600" type="submit">Update Student</button>
                    </div>
