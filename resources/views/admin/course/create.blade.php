    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="row gy-4">
                ...
                <form class="row gy-3 needs-validation" action="{{ route('course.store') }}" method="POST"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            placeholder="Enter name Name" value="{{ old('name') }}">
                       @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="duriation"
                            ...
                            placeholder="Enter Course Duration" value="{{ old('duriation') }}">
