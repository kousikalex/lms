    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            ...
            <div class="row gy-4">
                ...
                <form class="row gy-3 needs-validation" action="{{ route('course.update', $course->id) }}" method="POST"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            placeholder="Enter Course Name" value="{{ old('name', $course->name) }}">
                        @error('name')
                        ...
                        @if ($course->image)
                            <div class="mt-2">
                                ...
                                <img src="{{ asset('storage/' . $course->image) }}" alt="Course Image"
                                    style="max-width: 50px; height: 50px; border-radius: 6px;">
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="duriation"
                            class="form-control @error('duriation') is-invalid @enderror"
                            placeholder="Enter Course Duration" value="{{ old('duriation', $course->duriation) }}">
                        @error('duriation')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-primary-600" type="submit">Update Course</button>
                    </div>
                </form>
